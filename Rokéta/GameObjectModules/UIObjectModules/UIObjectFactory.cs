...
namespace Rokéta.GameObjectModules.UIObjectModules
{
	public class UIObjectFactory
	{
		...
		public Button CreateButton(double x, double y, int width, int height, string text = "",ConsoleColor foregroundColor = ConsoleColor.White, ConsoleColor backgroundColor = ConsoleColor.Black, UIEventHandler? command = null)
		{
			Button newButton = new Button(x,y,width,height,text,foregroundColor,backgroundColor, command);
