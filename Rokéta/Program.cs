...
void main()
{
	...
	uiObjectFactory.CreateButton(5,5,15,5,padTop:0,padBot:0, padLeft:0, padRight:0, text:"button1", textAlign:"CL",foreground:ConsoleColor.Green, background:ConsoleColor.Red);
